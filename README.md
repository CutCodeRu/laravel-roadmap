...
10. [ELOQUENT](eloquent/index.md)
    ...
    10. [Отношения "через" (Has One Through, Has Many Through)](eloquent/has-through.md)
    11. [Полиморфные отношения (Polymorphic relation)](eloquent/polymorphic-relationships.md)
    12. [Подзапросы (Subqueries)](eloquent/advanced-subqueries.md)
    13. [Model events](eloquent/events.md)
    14. [API resource](eloquent/eloquent-resources.md)
    15. [Курсорная пагинация](eloquent/cursor-paginator.md)
...
18. [PACKAGES](packages/index.md)
    ...
    3. [Частный репозиторий с помощью Satis](packages/satis.md)
    4. [Laravel Pint](packages/pint.md)
    5. [Laravel Folio](packages/folio.md)
    6. [Laravel Prompts](packages/prompts.md)
